...
//#region node_modules/.nitro/vite/services/ssr/assets/library-Q63Qt6_7.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-D4bzg0ua.js
...
var useCinevo = create()(persist((set, get) => ({
	...
	addInvite: (name, days) => set({ invites: [{
		id: `inv-${Date.now()}`,
	...
	setInviteStatus: (id, status) => set({ invites: get().invites.map((i) => i.id === id ? {
		...i,
		status
	} : i) }),
	...
	removeSource: (id) => {
		...
		import("./folder-handles-KUa2Z9nG.mjs").then((m) => m.deleteFolderHandle(id));
...
var styles_default = "/assets/styles-Bc6pxndR.css";
var APP_NAME = "CINEVO";
...
var $$splitComponentImporter$2 = () => import("./routes-Alb0R6uL.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./app-DAIoa_p8.mjs");
var Route$1 = createFileRoute("/app")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./node-DFQ2rTOd.mjs");
var Route = createFileRoute("/node")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
var rootRouteChildren = {
	...
	AppRoute: Route$1.update({
		id: "/app",
		path: "/app",
		getParentRoute: () => Route$3
	}),
	NodeRoute: Route.update({
		id: "/node",
		path: "/node",
		getParentRoute: () => Route$3
	})
...
//#endregion
export { mediaUrl as _, MOODS as a, scanFileList as b, genresIn as c, similarTo as d, deleteFolderHandle as f, isVideoFile as g, saveFolderHandle as h, useCinevo as i, pickFeatured as l, THEMES as m, libraryPool as n, byMood as o, reconnectFolders as p, titleById as r, filterCatalog as s, router_exports as t, recentlyAdded as u, playableCount as v, remoteTitle as y };
