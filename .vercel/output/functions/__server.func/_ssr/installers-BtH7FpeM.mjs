...
//#region node_modules/.nitro/vite/services/ssr/assets/installers-BtH7FpeM.js
...
function Logo({ size = "md", className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: cn("inline-block font-display font-extrabold tracking-tight leading-none text-cine-text", sizes[size], className),
		children: "CINEVO"
	});
}
		...
		children: INSTALLERS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "font-ui text-xs font-semibold uppercase tracking-[0.18em] text-cine-muted",
					children: item.label
				}),
...
//#endregion
export { checkNode as a, listNodeSections as c, revokeConnection as d, addNodeFolder as i, nodeStatus as l, Logo as n, cn as o, addNodeConnection as r, importNodeSections as s, InstallerCards as t, pairNode as u };
