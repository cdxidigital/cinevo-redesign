...
//#region node_modules/.nitro/vite/services/ssr/assets/library-C7iunbHr.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-LiPqbOFP.js
...
var useCinevo = create()(persist((set, get) => ({
	...
	removeSource: (id) => {
		...
		import("./folder-handles-D4BVdbsC.mjs").then((m) => m.deleteFolderHandle(id));
...
var styles_default = "/assets/styles-VyzyoGZz.css";
var APP_NAME = "CINEVO";
