...
//#region node_modules/.nitro/vite/services/ssr/assets/installers-BjzvIjD_.js
...
function Logo({ size = "md" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: cn("font-display font-extrabold tracking-tight leading-none text-cine-text", sizes[size]),
		children: "CINEVO"
	});
}
